...
S_DIMMING_EDPI_DARK="Built-in — Night, %"
S_DIMMING_EDPI_LIGHT="Built-in — Day, %"
S_DIMMING_EXT_DARK="External — Night, %"
S_DIMMING_EXT_LIGHT="External — Day, %"
S_DIMMING_TEST_DARK="🌙 Dark"
S_DIMMING_TEST_LIGHT="☀️ Light"
S_ENABLED="Enabled"
S_DISABLED="Disabled"
S_NOT_INSTALLED="n/a"
