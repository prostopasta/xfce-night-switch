...
S_DIMMING_ENABLE="Включить управление"
S_DIMMING_EXT_METHOD="Метод для внешних"
S_DIMMING_EDPI_DARK="Встроенный — Ночь, %"
S_DIMMING_EDPI_LIGHT="Встроенный — День, %"
S_DIMMING_EXT_DARK="Внешние — Ночь, %"
S_DIMMING_EXT_LIGHT="Внешние — День, %"
S_DIMMING_TEST_DARK="🌙 Ночь"
S_DIMMING_TEST_LIGHT="☀️ День"
S_ENABLED="Включено"
